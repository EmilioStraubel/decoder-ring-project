...
const polybiusModule = (function () {
  ...
  function polybius(input, encode = true) {
    //key-value pairs for alphabet value in cipher    
    const cipher = {                                                                      
 ...
 //key-value pairs for what each cipher number represents in alphabet
    const decoded = {                                                                    
    ...
    if(typeof input !== 'string') return false;
     //making entire input to lowercase so that we can ignore capital letters    
